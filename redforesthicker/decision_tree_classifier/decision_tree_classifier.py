...
class MyDecisionTreeClassifier(BaseDecisionTree):
    ...
    def _information_gain(self, y, y_left, y_right) -> float:
        """Compute the information gain for the split.
        
        Args:
            y (ndarray): The target vector.
            y_left (ndarray): The target vector for the left subset.
            y_right (ndarray): The target vector for the right subset.
        Returns:
        ...
        # Compute the weight of the left and right subsets
        weight_left = len(y_left) / len(y)
        weight_right = len(y_right) / len(y)
        
        # Compute the entropy after the split
        entropy -= weight_left * self._entropy(y_left)
        entropy -= weight_right * self._entropy(y_right)
        return entropy
        
    def _entropy(self, y) -> float:
        """Compute the entropy for the target vector.
